    ...
    <section id="contact" className="min-h-screen w-full flex-col items-center justify-center px-10 pb-16 pt-32 lg:py-40 lg:pl-40 lg:pr-20">
      ...
      <div className="mt-10 flex justify-center">
        <a
          ...
          className="font-poppins flex max-w-2xl flex-row items-center justify-center gap-2 text-center text-base leading-relaxed transition-all duration-300 hover:text-cyan-500 md:text-lg lg:text-xl"
        >
